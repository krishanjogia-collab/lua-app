...
export const metadata: Metadata = {
  title: 'Lua Learn | Expert-crafted Pre-K Curriculum',
  ...
  twitter: { card: 'summary_large_image', title: 'Lua Learn Curriculum' },
}
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-cream/80 backdrop-blur-md border-b border-cream-200">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="font-lexend text-2xl font-bold text-terracottaDark tracking-tight">Lua Learn</span>
          </div>
      ...
      <footer className="bg-white border-t border-cream-200 py-12 mt-20 text-center">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-left">
            ...
            <p className="text-sm text-sage-600 font-inter">Expert-crafted Pre-K curriculum planning.</p>
          </div>
